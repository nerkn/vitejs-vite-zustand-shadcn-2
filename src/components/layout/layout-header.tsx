      ...
      <div className="container flex h-14 max-w-screen-2xl items-center">
        ...
        <button className="lg:hidden mr-4 " onClick={toggleMenu}>
          <svg
            ...
            className="lucide lucide-panel-left-open h-6 w-6"
          >
        ...
        <div className="flex flex-col h-full p-0 py-6 z-60">
          ...
          <nav className="flex flex-col space-y-4  bg-white text-black dark:bg-black dark:text-white ml-0 py-10 pl-4 z-60">
            ...
            <Link
              href="https://premium.easyui.pro/"
              target="_blank"
              className="text-foreground hover:text-foreground/80 text-sm inline-flex items-center"
            >
              Premium Templates
            ...
            <p className="mt-auto flex flex-col space-y-4 leading-7 tracking-tight text-xs text-muted-foreground dark:text-gray-400  bg-white font-semibold dark:bg-black z-60">
              {' '}
              Socials
            </p>
            <Button
